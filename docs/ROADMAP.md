...
- Leg Length and Thigh/Calf Balance have explicit initial mathematical semantics. Arm Length and UpperArm/Forearm Balance now follow the same total-length/fixed-total-share model offline. Shoulder/Hip Width remain fixture controls, not finalized product controls; actual avatar fitting and hand alignment remain unverified.
